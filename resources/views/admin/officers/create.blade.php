...
<div class="uf-layout">
    ...
    <div style="display:flex;flex-direction:column;gap:1rem;">
        <div class="uf-card">
            ...
            <div class="uf-card-body">
                <p style="font-size:.78rem;color:#6b7280;line-height:1.6;margin:0;">
                    Officers are users who manage field operations and salary coordination. The <strong>officer</strong> role will be automatically assigned when the account is created.
                </p>
                <div style="margin-top:.75rem;padding:.5rem .75rem;background:#eef2ff;border-radius:6px;border:1px solid #c7d2fe;">
                    <p style="font-size:.72rem;color:#3730a3;margin:0;font-weight:600;">
        ...
        <div class="uf-card">
            ...
            <div class="uf-card-body">
                <div style="display:flex;align-items:center;gap:.5rem;padding:.4rem .65rem;background:#eef2ff;border:1px solid #c7d2fe;border-radius:6px;">
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#6366f1" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg>
                    <span style="font-size:.78rem;font-weight:600;color:#3730a3;">officer</span>
                </div>
            </div>
        </div>
    </div>
