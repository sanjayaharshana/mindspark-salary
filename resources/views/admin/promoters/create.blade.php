            ...
            <div class="pf-card-body">
                ...
                <div class="pf-row">
                    <div class="pf-group">
                        ...
                        <input class="pf-input @error('identity_card_no') pf-invalid @enderror" type="text" name="identity_card_no" value="{{ old('identity_card_no') }}" placeholder="NIC number" required>
                        @error('identity_card_no')<div class="pf-error">{{ $message }}</div>@enderror
                    </div>
                    <div class="pf-group">
                        <label class="pf-label">Phone No. <span class="pf-req">*</span></label>
                        <input class="pf-input @error('phone_no') pf-invalid @enderror" type="text" name="phone_no" value="{{ old('phone_no') }}" placeholder="Mobile number" required>
